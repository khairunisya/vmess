...
xrayvless1="vless://${uuid}@${domain}:$tls?path=/jrtunnel&security=tls&encryption=none&type=ws#${user}"
xrayvless2="vless://${uuid}@${domain}:$nontls?path=/jrtunnel&encryption=none&type=ws#${user}"
