...
#
cd /usr/bin
wget -O addgrpc "http://premium.vstunnel.com/main/grpc/addgrpc.sh"
wget -O delgrpc "http://premium.vstunnel.com/main/grpc/delgrpc.sh"
wget -O renewgrpc "http://premium.vstunnel.com/main/grpc/renewgrpc.sh"
wget -O cekgrpc "http://premium.vstunnel.com/main/grpc/cekgrpc.sh"
