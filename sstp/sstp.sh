...
# Link Hosting Kalian
akbarvpn="premium.vstunnel.com/main/sstp"
...
commonname=Jrtunnel.com
email=vstunnel@gmail.com
...
#input perintah sstp
wget -O /usr/bin/addsstp http://${akbarvpn}/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp http://${akbarvpn}/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp http://${akbarvpn}/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp http://${akbarvpn}/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
